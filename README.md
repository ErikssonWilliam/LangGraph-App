...
3.  **Extract**: Uses an LLM (gpt-4o-mini) to extract error codes. The model is prompted with system instructions as well as the error messages retrived from before.
